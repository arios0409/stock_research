#!/usr/bin/env python3
"""Draw triangle convergence chart for 300553 集智股份 and convert to PNG"""
...
out_dir = '/data/data/com.termux/files/home/storage/shared/Hermes_output/20260622_三角收敛'
os.makedirs(out_dir, exist_ok=True)
svg_path = os.path.join(out_dir, '300553_集智股份_三角收敛.svg')
with open(svg_path, 'w', encoding='utf-8') as f:
    f.write(svg_content)
print(f"SVG: {svg_path}")

import cairosvg
png_path = os.path.join(out_dir, '300553_集智股份_三角收敛.png')
